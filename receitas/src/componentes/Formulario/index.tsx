...
const Formulario = (): FormProp => {
    const localizacao = useLocation();

    console.log(localizacao);

    const { receitaSelecionada, fecharForm, setReceitaSelecionada } =
        useReceita();
                            ...
                            <li key={i}>
                                <input
                                    ...
                                    onChange={(
                                        ...
                                        const instrucoes =
                                            receitaSelecionada.instrucoes.map(
                                                (inst, j) =>
                                                    i === j
                                                        ? e.target.value
                                                        : inst,
                                        ...
                                        atualizarReceita({
                                            ...receitaSelecionada,
                                            instrucoes,
                                        }); //p cada elm se for msm indice pega o evento, se nao retorna o original
                                    }}
                                />
                            </li>
                        ))}
